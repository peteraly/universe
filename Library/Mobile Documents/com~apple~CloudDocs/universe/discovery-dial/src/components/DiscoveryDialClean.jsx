  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-indigo-500 via-purple-500 to-violet-600 flex flex-col items-center justify-center px-4 py-6 relative overflow-hidden">
      ...
      <motion.button
        ...
        className="px-6 py-3 rounded-xl bg-white/20 hover:bg-white/30 focus-visible:ring-2 focus-visible:ring-white/60 transition-all duration-200 text-white text-sm font-medium mb-6 border border-white/30 shadow-lg"
      ...
      <div className="grid grid-cols-2 gap-4 w-full max-w-80 mb-6">
        {[
          ...
          <motion.button
            ...
            className="flex flex-col items-center justify-center p-4 rounded-xl bg-white/12 hover:bg-white/16 focus-visible:ring-2 focus-visible:ring-white/60 transition-all duration-200 text-white min-h-[44px] border border-white/20 shadow-md"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
      ...
      <div className="fixed right-2 top-1/2 transform -translate-y-1/2 w-2 h-32 bg-white/30 rounded-full opacity-60 hover:opacity-100 transition-opacity duration-200 cursor-pointer">
...
export default DiscoveryDialClean
