...
export const ENHANCED_SAMPLE_EVENTS = [
  ...
  // ADDITIONAL EVENTS TO FILL GAPS
  // Professional - Workshops
  {
    id: 'professional-workshop-001',
    name: 'React Workshop',
    description: 'Learn React fundamentals and build a real project.',
    categoryPrimary: 'Professional',
    categorySecondary: 'Workshops',
    venue: 'Tech Academy',
    address: '456 Code St, San Francisco, CA',
    latitude: 37.7849,
    longitude: -122.4094,
    time: 'Morning',
    day: 'Today',
  ...
  // Social - Dining
  {
    id: 'social-dining-001',
    name: 'Foodie Meetup',
    description: 'Explore new restaurants and cuisines with fellow food lovers.',
    categoryPrimary: 'Social',
    categorySecondary: 'Dining',
    venue: 'Foodie Hub',
    address: '321 Food St, San Francisco, CA',
    latitude: 37.7849,
    longitude: -122.4094,
    time: 'Evening',
    day: 'Today',
    ...
    website: 'https://example.com/foodie-meetup'
  },
  ...
  // Arts/Culture - Theater
  {
    ...
    description: 'Watch an amazing local theater production.',
    categoryPrimary: 'Arts/Culture',
    categorySecondary: 'Theater',
    venue: 'Local Theater',
    address: '654 Arts Ave, San Francisco, CA',
    latitude: 37.7849,
    longitude: -122.4094,
    time: 'Evening',
    day: 'Today',
  ...
  // Arts/Culture - Film
  {
    ...
    venue: 'Cinema House',
    address: '147 Film Blvd, San Francisco, CA',
    latitude: 37.7849,
    longitude: -122.4094,
    time: 'Evening',
    day: 'Today',
    ...
    attendees: 60,
    maxAttendees: 80,
    organizer: 'Independent Cinema',
    tags: ['film', 'cinema', 'independent'],
    website: 'https://example.com/film-screening'
  },

  // Arts/Culture - Festivals
  {
    id: 'arts-festivals-001',
    name: 'Street Art Festival',
    description: 'Celebrate street art and urban culture.',
    categoryPrimary: 'Arts/Culture',
    categorySecondary: 'Festivals',
    venue: 'Street Art District',
    address: '258 Art District, San Francisco, CA',
    latitude: 37.7849,
    longitude: -122.4094,
    time: 'Afternoon',
    day: 'Weekend',
    ...
    tags: ['street art', 'festival', 'urban'],
    website: 'https://example.com/street-art-festival'
  },

  // Wellness - Fitness
  {
    id: 'wellness-fitness-001',
    name: 'Morning Yoga Class',
    description: 'Start your day with energizing yoga practice.',
    categoryPrimary: 'Wellness',
    categorySecondary: 'Fitness',
    venue: 'Yoga Studio',
    address: '369 Wellness Way, San Francisco, CA',
    latitude: 37.7849,
    longitude: -122.4094,
    time: 'Morning',
    day: 'Today',
  ...
  // Wellness - Outdoor
  {
    id: 'wellness-outdoor-001',
    name: 'Hiking Adventure',
    description: 'Explore beautiful trails and nature.',
    categoryPrimary: 'Wellness',
    categorySecondary: 'Outdoor',
    venue: 'Nature Trail',
    address: '741 Trail Rd, San Francisco, CA',
    latitude: 37.7849,
    longitude: -122.4094,
    time: 'Morning',
    day: 'Weekend',
  ...
  // Wellness - Mindfulness
  {
    ...
    attendees: 18,
    maxAttendees: 20,
    organizer: 'Mindfulness Center',
    tags: ['meditation', 'mindfulness', 'wellness'],
    website: 'https://example.com/meditation'
  },

  // Add some Night events
  {
    id: 'social-night-001',
    name: 'Late Night Networking',
    description: 'Networking event for night owls and late workers.',
    categoryPrimary: 'Social',
    categorySecondary: 'Networking',
    venue: 'Night Club',
    address: '963 Night Ave, San Francisco, CA',
    latitude: 37.7849,
    longitude: -122.4094,
    time: 'Night',
    day: 'Today',
...

  {
    ...
    description: 'Collaborative coding session for night developers.',
    categoryPrimary: 'Professional',
    categorySecondary: 'Workshops',
    venue: '24/7 Tech Hub',
    address: '159 Code Night, San Francisco, CA',
    latitude: 37.7849,
    longitude: -122.4094,
    time: 'Night',
    day: 'Today',
    ...
    tags: ['coding', 'night', 'collaboration'],
    website: 'https://example.com/night-coding'
  }
];
